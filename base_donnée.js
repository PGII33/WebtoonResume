// CECI EST LE FICHIER BASE DE DONNEE
...
const webtoon = [{
    ...
    personalReview: "Je n'ai pas beaucoup vu de Thriller mais celui-ci m'a beaucoup plu, on suit l'évolution du personnage principal avec grand intérêt, les moments de frissons sont bien rythmés, on compatis pour le personnage et comprend en même temps que lui ce qui lui arrive.",
...

{
    ...
    personalReview: "Une très bonne comédie, le personnage est attachant, certains personnages servent de running gag bien utilisé. Les graphismes sont simples et l'histoire drôle.",
    link: "https://www.webtoons.com/fr/sf/capitaine-zorgue/list?title_no=2370",
    lastEditDate: "9/11/23"
},

{
    title: "L'expert de la Tour Tutoriel",
    ...
    personalReview: "Une histoire assez banale avec un principe de tours à monter, récurrent dans pas mal de webtoons. Selon moi, ce webtoon est bien sans plus. Si vous n'accrochez de base que moyennement à ce type de webtoon, il y a mieux, plus diversifié. Celui-ci a son système mais ne sort pas vraiment de l'ordinaire. Malgré tout, si vous cherchez juste à lire quelque chose pour passer le temps, il s'agit alors d'un très bon webtoon.",
    vinReview: "Je le lisais, au début il y avait pas mal d'humour, mais plus on avance plus on s'éloigne du personnage de base et plus les 'blagues' tournent en rond. Donc j'ai laissé tombé autour de l'épisode 120.",
    link: "https://www.webtoons.com/fr/fantasy/expert-de-la-tour-tutoriel/list?title_no=2312",
    lastEditDate: "13/11/23"
},

{
    ...
    personalReview: "Franchement, une bonne série pour se détendre, l'humour est présent à foison, l'action aussi. Le mélange des 2 races nous donne des quiproquos drôles mais facilite aussi la vie du personnage principal qui lui aime bien embêter autrui. Il est impulsif mais drôle et attachant.",
...

{
    ...
    personalReview: "Ça semble un peu répétitif mais je le rassure, ça ne l'est pas. La première réincarnation est très courte pour laisser plus de place à la deuxième qui est beaucoup plus importante. Ce que j'aime bien dans ce webtoon c'est le fait que la fangirl me fait beaucoup rire. J'aime beaucoup l'histoire qui est créée dans cet univers et j'aime aussi beaucoup le fait que, pour une fois, les méchants sont les personnages principaux (pas les 2 persos principaux du webtoon, mais les 2 protagonistes de l'histoire dans laquelle Hestia s'est réincarnée). J'adore aussi beaucoup qu'elle les mène vraiment en bourrique. J'aime aussi beaucoup les dessins, mais ça c'est autre chose encore!",
...

{
    ...
    status: "En cours",
    chapters: 180(variable selon la langue et la plateforme),
    chapterSize: Long,
...

{
    ...
    personalReview: "Pas encore écris",
...

{
    ...
    personalReview: "Pas un simple système de tour le plus basique, on voit vraiment la façon de penser du personnage qui évolue...",
...

{
    ...
    personalReview: "Un Webtoon sympa, un peu cliché mais très drôle à lire, j'approuve.",
